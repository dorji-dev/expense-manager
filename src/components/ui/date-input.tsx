...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded-lg items-center px-[4px]">
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="p-0 outline-none w-[24px] border-none text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-[28px] border-none text-center"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="p-0 outline-none w-[48px] border-none text-center"
        placeholder="YYYY"
      />
    </div>
  );
